 ...
 */
final class Version20221021201300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD users_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D34A04AD67B3B43D ON product');
        $this->addSql('ALTER TABLE product DROP users_id');
    }
}
